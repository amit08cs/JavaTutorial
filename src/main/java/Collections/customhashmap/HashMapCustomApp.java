...
class HashMapCustom<K, V> {
   ...
   /**
    * Method allows you put key-value pair in HashMapCustomApp.
   ...
   /**
    * Method removes key-value pair from HashMapCustomApp.
    * @param key
    */
   ...
   /**
    * Method displays all key-value pairs present in HashMapCustomApp.,
    ...
    * This is very important method, as performance of HashMapCustomApp is very much
